  ...
  return (
    <main className="min-h-screen lg:h-screen bg-gradient-to-b from-[#fffefc] via-[#fffaf6] to-[#fff7f2] text-[#3f3125]">
      ...
      <div className="relative z-10 flex min-h-screen flex-col lg:h-screen">
        ...
        {/* Mobile chat sheet */}
        {isMobileChatOpen && (
          <div className="fixed inset-x-0 top-0 bottom-[56px] z-40 flex min-h-0 flex-col bg-[#fffefc]/95 backdrop-blur-sm lg:hidden">
            ...
            <div className="flex flex-1 min-h-0 flex-col bg-[#fffefc]/94 px-4 pt-4 pb-0">
              {renderChatPanel(
